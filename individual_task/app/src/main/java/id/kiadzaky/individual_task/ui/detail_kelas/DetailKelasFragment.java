...
import id.kiadzaky.individual_task.ui.instruktur.AddInstrukturActivity;
...
public class DetailKelasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        add_peserta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getContext(), AddDetailKelasActivity.class);
    ...
    private void tampilWebview() {
        ...
        web_view.loadUrl(Konfiguration.TABEL_DETAIL_KELAS );
    }
