            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <a href=<?=$link . "/individual_task/instruktur/tabelInstruktur.php"?>><i class="fas fa-arrow-left">Kembali</i></a>                                
                                <h4 class="card-title">Detail Instruktur </h4>
                                <form action=<?=$link."/individual_task/instruktur/updateInstruktur.php"?> method="POST">
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-1">
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <script>
        $.ajax({ 
                        type: 'GET', 
                        url: "<?=$link?>/individual_task/instruktur/tampilIns.php?id=<?=$id?>",  
                        dataType: 'json',
                        success: function (data) { 
                            console.log(data[0].id);
                            $('#ins_id').val(data[0].id);
                            $('#ins_nama').val(data[0].name);                            
                            $('#ins_email').val(data[0].email);
                            $('#ins_hp').val(data[0].number);
