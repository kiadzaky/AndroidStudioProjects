      ...
      <div class="modal-body">
        ...
        <?php 
            if(isset($_SESSION['pes_nama'])){
                ...
                <p>Instansi: <?=$_SESSION['pes_instansi']?></p>
                <?php
            }
        ...
        $(document).ready(function() {
            var link = window.location.hostname;
                    var table = $('#zero_config1').DataTable( {
                            "ajax": {
                                "url": "http://"+link+"/individual_task/peserta/tampilSemuaPes.php",
                            "dataSrc": ""
                            },
                            "columns": [
                                { "data": "id" },
                        ...
                        console.log();
                        // pindah halaman
                        window.location.href = "http://"+link+"/individual_task/peserta/formPeserta.php?id="+id;
                    } );
